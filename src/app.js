...
// import { verifytokenCall } from './components/Others/Utils.js';
                    ...
                    <ul className="pl-4 pt-4">
                      {(usertype === "client") ?
                        <>
                          ...
                          <li className="sidebar-dropdown">
                            <NavLink to='/savedtrainer' onClick={(e) => { document.body.classList.add('scrollHide'); }} className={({ isActive }) => isActive ? 'active' : ''}>
                          ...
                          <li className="sidebar-dropdown">
                            <NavLink to='/myWorkoutHistory' onClick={(e) => { callTrainer(e, '/myWorkout'); }} className={({ isActive }) => isActive ? 'active' : ''}>
